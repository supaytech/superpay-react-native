      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => {
            ...
            if(Platform.OS==='android'){
                NativeModules.SupayAndroidManager.pay('{"appid":"wxeae61855935702fb","noncestr":"f8b3dacef9c146f8a8e55e0f4630be5e","package":"Sign=WXPay","partnerid":"232028432","prepayid":"wx06200512915760d46c7c6ac32367430420","sign":"597ED7F160249C28A26021121DC1C919","timestamp":"1533557113"}',"WechatPay", (info)=>{
          ...
          <TouchableOpacity  onPress={() => {
              if(Platform.OS==='android'){
                  NativeModules.SupayAndroidManager.pay('{"appid":"wxeae61855935702fb","noncestr":"f8b3dacef9c146f8a8e55e0f4630be5e","package":"Sign=WXPay","partnerid":"232028432","prepayid":"wx06200512915760d46c7c6ac32367430420","sign":"597ED7F160249C28A26021121DC1C919","timestamp":"1533557113"}',"AliPay", (info)=>{
                    if (info.returnCode === '0'){
                        console.log('支付成功')
                    }else if (info.returnCode === '2'){
                        console.log('支付取消')
